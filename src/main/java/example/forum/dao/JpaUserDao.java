...
public class JpaUserDao extends AbstractDao implements UserDao  {
    ...
    public User findByEmail(String email) throws DataAccessException {
        String hqlQuery = "SELECT u FROM User u WHERE u.email LIKE ? ORDER BY u.id";
    ...
    public List<User> findAll() throws DataAccessException {
        String hqlQuery = "SELECT u FROM User u ORDER BY u.id";
